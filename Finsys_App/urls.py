...
urlpatterns = [
    ...
    path('Fin_getCustomers2',views.Fin_getCustomers2,name='Fin_getCustomers2'),
    
    path('Fin_createInvoiceCustomer2',views.Fin_createInvoiceCustomer2, name='Fin_createInvoiceCustomer2'),
    path('Fin_addCustomer2',views.Fin_addCustomer2, name='Fin_addCustomer2'),
    path('Fin_checkCustomerName2',views.Fin_checkCustomerName2, name='Fin_checkCustomerName2'),
    path('Fin_new_customer_payment_term2',views.Fin_newCustomerPaymentTerm2, name='Fin_newCustomerPaymentTerm2'),
     path('Fin_checkCustomerPhone2',views.Fin_checkCustomerPhone2, name='Fin_checkCustomerPhone2'),
    path('Fin_checkCustomerEmail2',views.Fin_checkCustomerEmail2, name='Fin_checkCustomerEmail2'),
     path('Fin_checkCustomerGSTIN2',views.Fin_checkCustomerGSTIN2, name='Fin_checkCustomerGSTIN2'),
     path('Fin_checkCustomerPAN2',views.Fin_checkCustomerPAN2, name='Fin_checkCustomerPAN2'),
